...
function ProfileForm({ profile, onDone }: ProfileFormProps) {
    ...
    <div className="flex flex-col items-center w-full max-w-sm gap-8">
      ...
      <div className="w-full flex flex-col gap-1.5">
        ...
        <Input
          ...
          className="w-full h-10 px-3 bg-zinc-600 text-white text-sm rounded-sm placeholder:text-white/30 focus:outline-nonen focus:ring-1 focus:ring-white/40 transition-colors"
        />
      </div>
      ...
      <div className="w-full flex flex-col gap-3">
        <Button
          ...
          className="h-10 bg-white text-black font-semibold text-sm rounded-sm hover:bg-white/80"
        >
