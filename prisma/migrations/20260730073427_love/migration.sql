...
CREATE TABLE "Movie" (
    ...
    "isTredngin" BOOLEAN NOT NULL DEFAULT false,
    "trailerUrl" TEXT,
    "videoUrl" TEXT,
    "cloudinaryId" TEXT,
    "duration" INTEGER,
...
-- CreateIndex
CREATE UNIQUE INDEX "MyList_profidId_movieId_key" ON "MyList"("profidId", "movieId");

-- AddForeignKey
ALTER TABLE "Profile" ADD CONSTRAINT "Profile_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "MyList" ADD CONSTRAINT "MyList_profidId_fkey" FOREIGN KEY ("profidId") REFERENCES "Profile"("id") ON DELETE CASCADE ON UPDATE CASCADE;
