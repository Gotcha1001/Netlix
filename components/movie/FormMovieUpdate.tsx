...
function FormMovieUpdate({ handleSubmit, movie }: Prop) {
  ...
  return (
    <div className="max-w-2xl py-6 w-full flex flex-col gap-4">
      <h1>Update Movie</h1>
      <form
        className="bg-brand-background p-6 rounded-lg shadow-md"
        action=""
        onSubmit={(e) => {
          e.preventDefault();
          handleSubmit({
        ...
        <FieldGroup>
          ...
          <Field>
            <FieldContent>
              ...
              >
                ...
                />
                {currentThumbnailUrl && (
                  <div className="overflow-hideen rounded-lg border bg-muted">
                    <Image
          ...
          <Field>
            <FieldContent>
              ...
              <FieldDescription>
                Upload the video file (MP$, MOV, AVI, MKV)
              </FieldDescription>
