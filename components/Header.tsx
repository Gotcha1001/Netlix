        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button className="flex items-center gap-1.5 outline-none group">
              <Image
                src={"/images/symbol--netflix.png"}
                alt={activeProfile?.name ?? "profile"}
                width={40}
                height={40}
                className="w-8 h-8 sm:w-10 rounded-sm object-cover shrink-0"
              />
              <ChevronDown
                size={16}
          ...
          >
            {profiles.map((profile) => {
              ...
              return (
                <DropdownMenuItem
                  ...
                  className={`flex items-center gap-3 px-3 py-2 rounded-sm cursor-pointer bg-transparent focus:bg-white hover:bg-transparent focus:text-white hover:underline ${
                ...
                >
                  <Image
                    ...
                    width={32}
                    height={32}
                    className={`w-8 h-8 rounded-sm object-cover shrink-0 transition-all ${
                      isActive ? "ring-2 ring-white" : "ring-1 ring-transparent"
                    }`}
                  />
            ...
            <DropdownMenuItem
              asChild
              className="flex items-center gap-3 px-3 py-2 rounded-sm cursor-pointer bg-transparent focus:bg-white"
            >
            ...
            <DropdownMenuItem
              ...
              className="flex items-center gap-3 px-3 py-2 rounded-sm cursor-pointer bg-transparent forus:bg-white"
            >
