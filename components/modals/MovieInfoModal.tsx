  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        transition={{ duration: 0.35, ease: "easeInOut" }}
        className="relative max-w-3xl w-full bg-[#181818] rounded-lg overflow-hidden z-10 max-h-[90vh] overflow-y-auto"
      >
        <div className="relative w-full aspect-video bg-black">
          {movie?.thumbnailUrl && (
            <Image
              ...
              width={1280}
              height={720}
              className={`w-full object-cover transition-opacity duration-500 ${isPlaying ? "opacity-0" : "opacity-10"}`}
            />
          )}
          ...
          <div className="absolute inset-x-0 bottom-0 px-8 pb-6 flex items-end justify-between z-10">
            ...
            <button
              className="w-10 h-10 flex items-center justify-center rounded-full border border-white/10--50 hover:border-white text-white transition-colors"
